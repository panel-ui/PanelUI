...
Tailwind CSS v4 and animated with Reanimated 4. **131 accessible, typed component modules** — buttons,
...
**131 component modules**, documented with live examples and full props tables at
...
- **Actions & navigation** — Button, ButtonGroup, ToggleButton, Fab, Menu, ContextMenu, Swipe,
  StackCard, SelectionMode, Sortable, Tabs, Breadcrumb, Pagination, SectionRail, Panelside, Tree,
  Chip, Badge
...
- **Data visualisation** — Plot, LineChart, LiveLineChart, AreaChart, BarChart, WaterfallChart,
  PyramidChart, ScatterChart, BubbleChart, BumpChart, CandlestickChart, PieChart, PolarAreaChart,
  FunnelChart, TreemapChart, RingChart, RadarChart, HeatmapChart, HexChart, Kpi, Map, Marker, Flow,
  QRCode
