...
<PreviewVideo
  src="/previews/compare.mp4"
  poster="/previews/compare-poster.jpg"
  alt="Compare — one landscape at two colour grades, with the seam dragged across it to swap the grey version for the warm one."
  width={720}
  height={1560}
/>
...
```tsx
import { Compare, Text, Button } from 'panelui-native';
```
...
<PreviewVideo
  src="/previews/compare-where-the-seam-starts.mp4"
  poster="/previews/compare-where-the-seam-starts-poster.jpg"
  alt="Compare — Where the seam starts."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/compare-a-seam-that-runs-the-other-way.mp4"
  poster="/previews/compare-a-seam-that-runs-the-other-way-poster.jpg"
  alt="Compare — A seam that runs the other way."
  width={720}
  height={1560}
/>
...
`disabled` holds the seam where it is and takes the handle out of the accessibility tree.

It is for a frame making one fixed point — a figure in a page, or a split that some other control owns. Nothing about the frame says it cannot be dragged, so put the split somewhere it reads as a chosen one rather than a starting one.

<PreviewVideo
  src="/previews/compare-frozen.mp4"
  poster="/previews/compare-frozen-poster.jpg"
  alt="Compare — Frozen."
  width={720}
  height={1560}
/>
...
One frame at two colour grades, with the seam starting in the middle. The drag is the whole picture rather than the knob, so a thumb anywhere on it moves the seam.
...
<Compare height={280}>
  <Compare.After>
    <Image source={graded} style={{ width: '100%', height: '100%' }} />
  </Compare.After>
  <Compare.Before>
    <Image source={original} style={{ width: '100%', height: '100%' }} />
  </Compare.Before>
...
Three buttons that snap the seam to an end or back to the middle. Dragging still moves it, and `value` stands back while a finger is down.

<PreviewVideo
  src="/previews/compare-driven-from-outside.mp4"
  poster="/previews/compare-driven-from-outside-poster.jpg"
  alt="Compare — Driven from outside."
  width={720}
  height={1560}
/>
...
<Button variant="outline" onPress={() => setSplit(0)}>After</Button>
<Button variant="outline" onPress={() => setSplit(0.5)}>Half</Button>
<Button variant="outline" onPress={() => setSplit(1)}>Before</Button>
```

### A readout in the middle

The frame fills the screen and a panel over the centre says how much of the grade is on show, as a number and as a word. Both change while the seam travels under them, so the picture and the caption never disagree.

<PreviewVideo
  src="/previews/compare-a-readout-in-the-middle.mp4"
  poster="/previews/compare-a-readout-in-the-middle-poster.jpg"
  alt="Compare — A readout in the middle."
  width={720}
  height={1560}
/>
...
<Compare height={screen} defaultValue={0.38} onValueChange={setSplit} className="rounded-none">
  <Compare.After>{/* … */}</Compare.After>
  <Compare.Before>{/* … */}</Compare.Before>
  <View pointerEvents="none" className="absolute inset-0 items-center justify-center">
    <View className="items-center gap-1 rounded-2xl bg-foreground/80 px-6 py-4">
      <Text size="3xl" weight="semibold" className="text-background">{`${percent}%`}</Text>
      <Text size="sm" className="text-background/70">{stage(percent)}</Text>
    </View>
  </View>
  <Compare.Handle>
    <View className="h-12 w-1.5 rounded-full bg-background" />
