...
<PreviewVideo
  src="/previews/bump-chart.mp4"
  poster="/previews/bump-chart-poster.jpg"
  alt="BumpChart — five clubs ranked over seven weeks, with Harbour picked out in green against the rest of the table."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/bump-chart-basic.mp4"
  poster="/previews/bump-chart-basic-poster.jpg"
  alt="BumpChart — Basic."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/bump-chart-ranked-from-scores.mp4"
  poster="/previews/bump-chart-ranked-from-scores-poster.jpg"
  alt="BumpChart — Ranked from scores."
  width={720}
  height={1560}
/>
...
<Preview
  src="/previews/bump-chart-picking-a-line.jpg"
  alt="BumpChart — Picking a line."
  width={1179}
  height={1165}
/>
...
<PreviewVideo
  src="/previews/bump-chart-changing-data.mp4"
  poster="/previews/bump-chart-changing-data-poster.jpg"
  alt="BumpChart — Changing data."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/bump-chart-loading.mp4"
  poster="/previews/bump-chart-loading-poster.jpg"
  alt="BumpChart — Loading."
  width={720}
  height={1560}
/>
