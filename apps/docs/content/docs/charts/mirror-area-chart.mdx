...
<PreviewVideo
  src="/previews/mirror-area-chart.mp4"
  poster="/previews/mirror-area-chart-poster.jpg"
  alt="MirrorAreaChart — queued jobs and their high-priority part above a baseline, with the high-priority share mirrored below it."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/mirror-area-chart-basic.mp4"
  poster="/previews/mirror-area-chart-basic-poster.jpg"
  alt="MirrorAreaChart — Basic."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/mirror-area-chart-two-scales.mp4"
  poster="/previews/mirror-area-chart-two-scales-poster.jpg"
  alt="MirrorAreaChart — Two scales."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/mirror-area-chart-errors-under-traffic.mp4"
  poster="/previews/mirror-area-chart-errors-under-traffic-poster.jpg"
  alt="MirrorAreaChart — Errors under traffic."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/mirror-area-chart-loading.mp4"
  poster="/previews/mirror-area-chart-loading-poster.jpg"
  alt="MirrorAreaChart — Loading."
  width={720}
  height={1560}
/>
