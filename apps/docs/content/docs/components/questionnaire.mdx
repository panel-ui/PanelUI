...
<Preview
  src="/previews/questionnaire-one-answer-at-a-time.jpg"
  alt="Questionnaire — one question, an answer chosen, and only the actions that apply to it."
  width={1179}
  height={2563}
/>
...
<Preview
  ...
  alt="Questionnaire — a multiple-answer question, its choices drawn as squares."
  width={1179}
  height={2563}
/>
...
<Preview
  ...
  alt="Questionnaire — fixed choices with a text field under them for anything they do not offer."
  width={1179}
  height={2563}
/>
...
It goes beside the primary action, in place of Back rather than alongside it. Three actions in the band come out narrow enough to truncate the one carrying the flow, and a row of three reads as three equal decisions when only one of them is the way forward.
...
<Preview
  ...
  alt="Questionnaire — every answer badged with a letter, the disabled one skipped."
  width={1179}
  height={2563}
/>
...
That is what the shot below is: every choice outlined, the message under them, and the way forward still there to be pressed. `Questionnaire.Next` dims rather than disabling itself, because a button that refuses without saying why leaves the reader nothing to act on.

<Preview
  src="/previews/questionnaire-checking-an-answer-against-a-schema.jpg"
  alt="Questionnaire — a question marked invalid: every choice outlined and the error under them."
  width={1179}
  height={2563}
/>
...
<Preview
  ...
  alt="Questionnaire with frame={false}, inside a card that draws its own boundary."
  width={1179}
  height={2563}
/>
