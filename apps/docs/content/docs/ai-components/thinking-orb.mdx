...
<PreviewVideo
  src="/previews/thinking-orb.mp4"
  poster="/previews/thinking-orb-poster.jpg"
  alt="A screen recording of the ThinkingOrb demo on a dark phone screen. Six dotted orbs animate side by side — particles running tilted orbits, a scan meridian sweeping a globe, bands scrambling and clicking back, a waveform rolling through rings, an undulating sash, and an outline morphing between a circle, a triangle and a square."
  width={720}
  height={684}
  caption="Six states, each a distinct silhouette in motion. Every dot is drawn on the UI thread."
/>
