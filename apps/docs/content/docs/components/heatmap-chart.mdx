...
<PreviewVideo
  ...
  alt="A screen recording of the HeatmapChart demo on a dark phone screen. A year of contribution cells shaded across a colour ramp scrolls sideways, and a held press brings up a readout that follows the finger across the grid."
  width={720}
  height={660}
  caption="A year of cells, scrolled sideways. Hold to read a day — a swipe scrolls instead."
/>
